...
public class AccountsPageTest extends BaseTest {
	...
	public void accPageURLTest() {
		...
		Assert.assertTrue(actURL.contains(Constants.ACCOUNTS_PAGE_HEADER));
	}
	...
	public void accPageSectionsTest() {
		...
		System.out.println("Act Account Section List: " + actAccSecList);
...
//	}
	...
	public void addToCartTest() {
		...
		System.out.println("cart message is : " + actSuccessMessg);
